<template>
  <div class="color">
    <h2>RGB颜色查询对照表 - Color Compare</h2>
    <div class="note">
      <span># 单击更改底色</span>
      <span># 右击复制</span>
    </div>
    <div class="color-list" :style="{ 'background-color': color }">
      <ColorItem v-for="color in colors" :key="color" :color="color" @click.prevent.right="copy(color)"
...
import ColorItem from "../../components/ColorItem/index.vue";
